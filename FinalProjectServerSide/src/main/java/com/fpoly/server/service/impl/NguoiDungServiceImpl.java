...
public class NguoiDungServiceImpl implements NguoiDungService {
	...
	@Override
	public NguoiDungResponse findOne(String idNguoiDung) {
		return repo.findOne(idNguoiDung);
	}
	...
	@Override
	public List<NguoiDungResponse> findByTrangThaiKichHoat(Boolean trangThaiKichHoat) {
		return repo.findByTrangThaiKichHoat(trangThaiKichHoat);
	}

	@Override
	public List<NguoiDungResponse> findByTrangThaiHoatDong(Boolean trangThaiHoatDong) {
