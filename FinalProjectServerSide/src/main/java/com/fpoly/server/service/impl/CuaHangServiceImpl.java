...
public class CuaHangServiceImpl implements CuaHangService {
	...
	@Override
	public CuaHangResponse findOne(String idCuaHang) {
		try {
	...
	@Override
	public CuaHangResponse findByIdNguoiDung(String idNguoiDung) {
		try {
	...
	@Override
	public List<CuaHangResponse> findByTenCuaHang(String tenCuaHang) {
		try {
